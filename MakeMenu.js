...
function addNewItemColumn() {
  try {
    ...
    settingsSheet.getRange(newSettingsRow, 1, 1, 10).setBorder(true, true, true, true, true, true);
    ...
    // 罫線を設定
    const newAppSheetRange = appSheet.getRange(1, lastCol + 1, appSheet.getMaxRows(), 2);
